...
export const projects = [
  ...
  {
    title: "CryptoPunks",
    description: "A modern, responsive web application showcasing CryptoPunks NFT marketplace built with Next.js, React, TypeScript, and Tailwind CSS.",
    imageSrc: CryptoPunks,
    liveUrl: "https://crypto-punks-sandy.vercel.app/",
    githubUrl: "https://github.com/fazal-bhinder/CryptoPunks",
  },
  {
    title: "Medium Clone",
